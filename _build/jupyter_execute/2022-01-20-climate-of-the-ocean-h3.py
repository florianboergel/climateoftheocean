...
# Look at this figure and zoom on the connection between the world ocean and the Baltic Sea.
# 
# (lon=8-17, lat=53-59)
# 
...
danish_straits = ds.sel(xt_ocean=slice(8, 17), yt_ocean=slice(53, 59))
...
# Often this is followed by something similar to:
# 
# >The inflow of freshwater by river runoff, a positive net precipitation cause a positive water balance with respect to the North Sea. The positive water balance leads to strong gradients in salinity and ecosystem variables (Reckermann et al., 2008).
...
ds_temp_season = ds.temp.resample(time="1M").mean().isel(st_ocean = 0)
